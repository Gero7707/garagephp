...
class User extends BaseModel
{
    ...
    {
        if(empty(trim($username)) || strlen($username) > 500) {
    ...
    public function save():bool{
        ...
        if ($this->user_id === null) {
            ...
            //On lie les paramètres pour les mises à jour
            $param = [':username'=> $this->username,
                ':email'=> $this->email,
                ':role'=> $this->role,//ATTENTION le mot de passe est déjà Hasché
    ...
    public function authenticate(string $email, string $password): ?static{
        ...
        //on verifie que l'utilisateur existe et que le mot de passe fournie correspond au mot de passe Hasché stocké
    ...
    /**
     * Cette methode rempli les propriétés de l'objet pour inserer en BDD
     */
